...
1. module metadata (`defineModule` block)
...
These metadata are defined in the `defineModule` code block at the start of the file, and are intended to be both human and machine readable.
