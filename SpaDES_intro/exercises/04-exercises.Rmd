...
2. Identify the timestep used for each module? How do they# Module metadata
...
1. make a copy of the `gameOfLife` module, called `gameOfLifeError`
...
2. change all instances of `gameOfLife` to `gameOfLifeError` (use RStudio's find-relpace feature: `Ctrl` + `F`)

3. edit line 100 to read:
