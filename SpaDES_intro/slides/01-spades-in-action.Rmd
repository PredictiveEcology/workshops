...
whereSamples <- file.path(whereSpaDES, "sampleModules")
file.path(whereSamples, "caribouMovement", "caribouMovement.R") %>%
file.edit()
```

## 2. [Simple forest dynamics model](http://htmlpreview.github.io/?https://github.com/PredictiveEcology/SpaDES-modules/blob/master/modules/LCC2005/LCC2005.html)

- More modules than SpaDES demo
- Vegetation component is simple, but data-driven
- Neither caribou, nor fire data-driven
...
- Freely available on [SpaDES-Modules](http://github.com/PredictiveEcology/SpaDES-Modules) repository
- SpaDES-Modules repository is intended to be like CRAN, for SpaDES modules
...
downloadModule("LCC2005", path = tempdir()) 
# can look at module or helper .Rmd file
openModules("LCC2005", path = tempdir()) 
```
...
- Allows scientist easier access to code, e.g., 
    ...
    - for making growth climate sensitive
    - for changing mortality functions
    - for dividing up large problems into small parallel problems
- Not yet published
...
- Features:
    ...
    - Data summaries
    - Pre-run results
    - Can be posted online, once public (Publish button top right)
