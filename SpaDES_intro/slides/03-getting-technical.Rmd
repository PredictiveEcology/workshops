...
accessors <- c('envir', 'modules', 'params', 'events', 'current', 'completed', 'depends', 'times', 'inputs', 'outputs', 'path') %>% 
  paste0('()')
...
other_accessors <- c('packages', 'globals', 'start', 'end', 'timeunit', 'timeunit', 'objects', 'paths', 'cachePath', 'inputPath', 'outputPath', 'modulePath') %>%
  paste0('()')
