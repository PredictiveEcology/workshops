...
- Can use your own computer, a local cluster, a server, cloud and more.

- We can access Compute Canada for free, though sometimes the queues are long:
...
- There is a different example here:
    ...
    - [ssh among Linux machines](http://htmlpreview.github.io/?https://github.com/PredictiveEcology/SpaDES-modules/blob/master/modules/wolfAlps/wolfAlps.html#below-here-is-for-advanced-users)  
...
predVals <- predict(glmObj, newdata = 
          data.frame(diamCM = 
            rlnorm(nTrees, meanlog = 2, sdlog = 0.7)))
...
## Indirectly from data - Pattern Oriented Modeling
